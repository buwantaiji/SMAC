...
for j in range(N):
    ...
    positions[a[0]] = a[0]
# NOTE: All the configuration information----including positions of N particles and permutation informations
#   ----are totally included in the dictionary object "positions".
for step in range(nsteps):
    # Sample a new path using levy construction.
    ...
    # Sample a new permutation using Metropolis acceptance probability.
