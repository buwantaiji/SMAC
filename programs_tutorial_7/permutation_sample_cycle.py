...
print "N = %d" % N
print "cycle length(1 ~ N) | experimental average number of times a cycle of length k appears in a N-permutation configuration"
for k in range(1, N + 1):
    print k, stats[k] / float(samples_num) 
